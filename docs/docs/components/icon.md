...
`size` 属性可以改变 `icon` 的大小，需要传入指定的单位大小

<tyh-icon size="50px" icon="tyh-ui-hide" />
<tyh-icon size="40px" icon="tyh-ui-shouye-xianxing" />
<tyh-icon size="30px" icon="tyh-ui-huojian" />
...
<div id="allIcon">
  <ul class="allIcon-ui">
    <li
      ...
      @click="copy(icon)"
    >
      <tyh-icon size="34px" :icon="icon" color="rgb(102,102,102)" />
